...
@pytest.mark.parametrize(
    ("kwargs", "event"),
    [
        ({"user_id": "u2", "status_min": None, "level": None, "method": None, "request_id": None}, {"user_id": "u1"}),
        ({"user_id": None, "status_min": 400, "level": None, "method": None, "request_id": None}, {"status_code": 200}),
        ({"user_id": None, "status_min": None, "level": "warning", "method": None, "request_id": None}, {"level": "info"}),
        ({"user_id": None, "status_min": None, "level": None, "method": "POST", "request_id": None}, {"method": "GET"}),
        ({"user_id": None, "status_min": None, "level": None, "method": None, "request_id": "r2"}, {"request_id": "r1"}),
    ],
)
