...
async def get_repair_costs(
    ...
    await enforce_rate_limit(
        request, "analytics:costs:repairs", ANALYTICS_LIMIT, ANALYTICS_WINDOW
    )
...
async def get_asset_costs(
    ...
    await enforce_rate_limit(
        request, "analytics:costs:assets", ANALYTICS_LIMIT, ANALYTICS_WINDOW
    )
    return await run_analytics_operation(
        request,
...
async def get_region_costs(
    ...
    await enforce_rate_limit(
        request, "analytics:costs:regions", ANALYTICS_LIMIT, ANALYTICS_WINDOW
    )
    return await run_analytics_operation(
        request,
