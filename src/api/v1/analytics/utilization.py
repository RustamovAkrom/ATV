...
from api.dependencies.analytics import get_utilization_analytics_domain_service
...
router = APIRouter(prefix="/analytics/utilization", tags=["Analytics - Utilization"])
