...
async def get_assignment_trends(
    ...
    await enforce_rate_limit(
        request, "analytics:trends:assignments", ANALYTICS_LIMIT, ANALYTICS_WINDOW
    )
...
async def get_transfer_trends(
    ...
    await enforce_rate_limit(
        request, "analytics:trends:transfers", ANALYTICS_LIMIT, ANALYTICS_WINDOW
    )
    return await run_analytics_operation(
        request,
...
async def get_repair_trends(
    ...
    await enforce_rate_limit(
        request, "analytics:trends:repairs", ANALYTICS_LIMIT, ANALYTICS_WINDOW
    )
    return await run_analytics_operation(
        request,
