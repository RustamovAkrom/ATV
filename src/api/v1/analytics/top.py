...
@router.get("/users", response_model=list[TopUserAnalyticsOut], dependencies=[Depends(AssetPermissions.CanViewAssets)])
...
@router.get("/services", response_model=list[TopServiceAnalyticsOut], dependencies=[Depends(AssetPermissions.CanViewAssets)])
