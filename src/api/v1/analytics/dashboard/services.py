...
async def get_service_breakdown(
    ...
    await enforce_rate_limit(request, "analytics:dashboard:services", DASHBOARD_LIMIT, DASHBOARD_WINDOW)
    return await run_analytics_operation(request, "analytics.dashboard.services", {}, lambda: service.get_breakdown(), lambda: [])
