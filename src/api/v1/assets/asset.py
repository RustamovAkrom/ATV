...
from schemas.asset_assignments import (
    AssetAssignmentRequest,
    AssetReassignmentRequest,
)
from schemas.asset_transfers import AssetTransferCreate, AssetTransferDecision, AssetTransferSchema
...
from schemas.bulk import BulkAssignRequest, BulkResult, BulkStatusRequest, BulkTransferRequest
...
@router.post("/", response_model=AssetDetailSchema, dependencies=[presets.CanCreateAssets])
...
@router.post("/bulk/assign", response_model=BulkResult, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/bulk/transfer", response_model=BulkResult, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/bulk/status", response_model=BulkResult, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
async def bulk_update_asset_status(
    ...
    return await service.bulk_update_status(data.asset_ids, data.status, current_user.id)
...
@router.get("/{asset_id}", response_model=AssetDetailSchema, dependencies=[presets.CanViewAssets])
async def get_asset(
    asset_id: UUID,
    service: AssetService = Depends(get_asset_service),
):
...
@router.patch("/{asset_id}", response_model=AssetDetailSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/{asset_id}/assign", response_model=AssetDetailSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/{asset_id}/unassign", response_model=AssetDetailSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/{asset_id}/reassign", response_model=AssetDetailSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/{asset_id}/status", response_model=AssetDetailSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/{asset_id}/transfer", response_model=AssetTransferSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/{asset_id}/transfer/{transfer_id}/approve", response_model=AssetTransferSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
async def approve_asset_transfer(
    ...
    return await service.approve_transfer(asset_id, transfer_id, current_user.id, data.comment)


@router.post("/{asset_id}/transfer/{transfer_id}/reject", response_model=AssetTransferSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
async def reject_asset_transfer(
    ...
    return await service.reject_transfer(asset_id, transfer_id, current_user.id, data.comment)


@router.post("/{asset_id}/repair/report", response_model=RepairSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/{asset_id}/repair/{repair_id}/start", response_model=RepairSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/{asset_id}/repair/{repair_id}/complete", response_model=RepairSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/{asset_id}/repair/{repair_id}/cancel", response_model=RepairSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/{asset_id}/documents", response_model=AssetDocumentSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.delete("/{asset_id}/documents/{document_id}", dependencies=[presets.CanDeleteAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.post("/{asset_id}/warehouse", response_model=AssetDetailSchema, dependencies=[presets.CanUpdateAssets])
@invalidate_cache(tags=("assets:list",))
...
@router.get("/{asset_id}/history", response_model=list[AssetHistorySchema], dependencies=[presets.CanViewAssets])
