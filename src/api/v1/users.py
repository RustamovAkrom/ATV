...
from schemas.users_schema import (AdminUserUpdateSchema,
...
@router.get("/", response_model=list[UserOutSchema], dependencies=[presets.CanViewUsers])
...
@router.get("/search", response_model=list[UserOutSchema], dependencies=[presets.CanViewUsers])
...
@router.get("/{user_id}", response_model=UserOutSchema, dependencies=[presets.CanViewUsers])
