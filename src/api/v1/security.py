...
from schemas.common_schema import StatusResponse
from schemas.security_schema import (ForgotPasswordRequestSchema,
...
async def forgot_password(
    ...
    return StatusResponse(
        status="ok",
        message="If the acccount exists, a reset link has been sent."
    )
