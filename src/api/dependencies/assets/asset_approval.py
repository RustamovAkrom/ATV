...
def get_approval_service(
    ...
    asset_assignment_service: AssetAssignmentService = Depends(get_asset_assignment_service),
    warehouse_service: WarehouseService = Depends(get_warehouse_service),
    approval_events: ApprovalEventService = Depends(get_approval_event_service),  # <-- добавить ApprovalEventService
) -> ApprovalService:
