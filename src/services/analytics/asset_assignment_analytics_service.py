...
class AssetAssignmentAnalyticsService:
    ...
    async def list_assignments(
        ...
        items = [
            AssetAssignmentDetailOut(
                ...
                user_email=(
                    self._filter_email(a.user.email, current_user) if a.user else ""
                ),
    ...
    async def get_assignment_with_duration(
        self, assignment_id: UUID
    ) -> AssetAssignmentDetailOut | None:
    ...
    async def get_user_summary(
        ...
        summary_dict["user_email"] = self._filter_email(
            summary_dict["user_email"], current_user
        )
